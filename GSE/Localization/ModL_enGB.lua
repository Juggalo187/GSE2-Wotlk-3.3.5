local L = LibStub("AceLocale-3.0"):NewLocale("GSE", "enGB", true)
...
L["Sequence '%s' has been completely deleted."] = true
...
L["How many pixels high should the Editor start at."] = true
L["Default Editor Width"] = true
L["How many pixels wide should the Editor start at."] = true
